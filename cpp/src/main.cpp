...
int main(int argc,char* argv[])
{
    ...
    const std::string model_folder = "/home/wenxin/Desktop/SAIL/7DOF/iiwa14/urdf/";

    const std::string urdf_path = model_folder + "iiwa14.urdf";
    ...
    const std::string ee_link_name = "iiwa14_link_ee";
    ...
    ADData::Matrix6x ad_jac_ee(6, ad_model.nv); ad_jac_ee.fill(0.);
    pin::getFrameJacobian(ad_model, ad_data, 
                        ee_frame_id, pin::LOCAL_WORLD_ALIGNED, ad_jac_ee);
